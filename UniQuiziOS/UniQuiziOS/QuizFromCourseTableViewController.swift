//
//  QuizFromCourseTableViewController.swift
//  UniQuiziOS
//
...
class QuizFromCourseTableViewController: UITableViewController {

    var quizzes  = [Quiz]()
    var coursePk : Int?
    
    func getCourses(){
        guard let url = URL(string: Properties.getQuizFromCourseURL(course : coursePk!)) else {return}
        print(url)
